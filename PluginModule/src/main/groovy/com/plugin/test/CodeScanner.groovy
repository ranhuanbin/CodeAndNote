...
//        println('classes:' + entryName)
    ...
    class ScanClassVisitor extends ClassVisitor {
        ...
        void visit(int version, int access, String name, String signature,
            ...
            println("CodeScanner.visit.1------------------------------------------------------------start\n" +
                    "name: ${name}\n" +
                    "signature: ${signature}\n" +
                    "superName: ${superName}\n" +
                    "interfaces: ${interfaces}\n" +
                    "CodeScanner.visit.1------------------------------------------------------------end\n")
        ...
        void gotOne(String interfaceName, String className, RegisterInfo ext) {
            println("CodeScanner.gotOne.1------------------------------------------------------------start\n" +
                    "interfaceName: ${interfaceName}\n" +
                    "className: ${className}\n" +
                    "RegisterInfo: ${ext}\n" +
                    "CodeScanner.gotOne.1------------------------------------------------------------end\n")
    ...
    boolean hitCache(File jarFile, File destFile) {
        println("CodeScanner.hitCache.1------------------------------------------------------------start\n" +
                "jarFilePath: ${jarFile.absolutePath}\n" +
                "infoList: ${infoList}\n" +
                "CodeScanner.hitCache.1------------------------------------------------------------end\n")
