...
public class ProjectModuleManager {
    ...
    /**
     * 为区别于组件单独以APP方式运行的task, 将组件module打包成aar时, 在local.properties文件中添加assemble_aar_for_cc_component = true
     */
    ...
    /**
     * apply了cc-settings-2.gradle的module, 但不是组件, 而是一直作为library被其他组件依赖
     */
    ...
    static boolean manageModule(Project project) {
        ...
        println("ProjectModuleManager.initByTask.2------------------------------------------------------------start\n" +
                "currentProject: ${project}, \n" +
                "task: ${project.gradle.startParameter.taskNames}, \n" +
                "mainApp: ${mainApp}, \n" +
                "assembleFor: ${assembleFor}, \n" +
                "buildingAar: ${buildingAar}, \n" +
                "alwaysLib: ${alwaysLib}, \n" +
                "taskIsAssemble: ${taskIsAssemble}, \n" +
                "mainModuleName: ${mainModuleName}, \n" +
                "runAsApp: ${runAsApp}\n" +
