...
class RegisterExtension {
    ...
    void convertConfig() {
        println("RegisterExtension.convertConfig.1------------------------------------------------------------start\n" +
                "registerInfoSize: ${registerInfo.size()}\n" +
                "RegisterExtension.convertConfig.1------------------------------------------------------------end\n")
        registerInfo.each { map ->
            ...
            println("RegisterExtension.convertConfig.3------------------------------------------------------------start\n" +
                    ...
                    "registerMethodName: ${info.registerMethodName}\n" +
                    "registerClassName: ${info.registerClassName}\n" +
