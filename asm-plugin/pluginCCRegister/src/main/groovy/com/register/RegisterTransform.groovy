...
import com.register.cc.generator.ManifestGenerator
import com.register.cc.generator.ProviderGenerator
import com.register.cc.generator.RegistryCodeGenerator
...
class RegisterTransform extends Transform {
    ...
    private static void scanClassFile(File file, String root, boolean leftSlash, CodeScanner scanProcessor, File dest) {
        ...
        if (file.isFile()) {
            ...
            println("file = " + file + ", entryName = " + entryName)
