...
public class McNormalMethodAdapter extends AdviceAdapter {
    private String className;

    public McNormalMethodAdapter(String classname, MethodVisitor methodVisitor, int access, String name, String descriptor) {
